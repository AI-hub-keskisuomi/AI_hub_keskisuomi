...
4. Handling missing values. Missing values in the summed variables were imputed by using median imputation. Individual psychological variables were imputed by using 10-nearest neighbors imputation.
5. 
