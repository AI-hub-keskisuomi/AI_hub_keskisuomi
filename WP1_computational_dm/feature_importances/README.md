...
The obtained feature importances were based on regression and classification results. The regression models were used for predicting continuous valued weight information and classification models attempted to predict weight loss as a categorical variable (i.e., data vector was labeled to 1 if weight loss was at least 2.5 % and labeled to 0 otherwise).    
